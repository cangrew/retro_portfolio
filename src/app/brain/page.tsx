...
export const metadata: Metadata = {
  title: "Brain",
  description: "Neural visualization — digital mind",
};
    ...
    <main className="relative z-10 min-h-screen pt-20 pb-8 px-4 md:px-8">
      <div className="max-w-4xl mx-auto space-y-4">
        <RetroWindow title="NEURAL.EXE — DIGITAL MIND v1.0">
          ...
          <BrainScene heightClass="h-[65vh]" />

          <div className="mt-3 flex flex-wrap gap-x-6 gap-y-1 font-mono text-xs text-retro-fg-dim">
